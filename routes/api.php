...
Route::post('/items/add/ajax', [App\Http\Controllers\ItemController::class, 'ajax_main']); 
Route::post('/items/add/ajax', [App\Http\Controllers\ItemController::class, 'ajax_sub']); 